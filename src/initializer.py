...
def load_effiunet_params(args, network):

    if args.pretrained_backbone:
        network = load_backbone(network, args.pretrained_backbone, args)
        print('load pre-trained backbone {} into network'.format(args.pretrained_backbone))
    else:
        print('Not load pre-trained backbone, please be careful')

    if args.resume_effiunet:
        param_dict = load_checkpoint(args.resume_effiunet)
        param_dict_new = {}
